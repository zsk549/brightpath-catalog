    ...
    <footer className="bg-primary text-primary-foreground mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/politica-privacidade" className="text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  Política de Privacidade
                </Link>
              </li>
              <li>
                <Link to="/politica-troca" className="text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
